...
const checkAuth = (requiredRole) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existUser = yield user_model_1.User.findOne({ email: verifiedToken === null || verifiedToken === void 0 ? void 0 : verifiedToken.email });
        if (!existUser) {
            throw new AppError_1.AppError(404, "User is not Found");
        }
        if (existUser.isVerified === false) {
            throw new AppError_1.AppError(401, "This is Not verified User");
        }
